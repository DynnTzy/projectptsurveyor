<?= view('layouts/header', ['title' => 'Tambah Cabang']) ?>

<div class="card-shadow bg-white rounded-lg p-6 max-w-2xl mx-auto">

    <h1 class="text-xl font-semibold mb-4">Tambah Cabang</h1>
    ...
    <form action="/master/cabang/store" method="post" class="space-y-4">
        <?= csrf_field() ?>
